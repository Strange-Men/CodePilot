...
class Settings(BaseSettings):
    ...
    real_llm_provider: str = Field(default="mimo", alias="REAL_LLM_PROVIDER")
    ...
    doubao_model_name: str = Field(default="", alias="DOUBAO_MODEL_NAME")
    deepseek_api_key: str | None = Field(default=None, alias="DEEPSEEK_API_KEY")
    deepseek_base_url: str = Field(default="", alias="DEEPSEEK_BASE_URL")
    deepseek_model_name: str = Field(default="", alias="DEEPSEEK_MODEL_NAME")
    max_files: int = 300
