...
class EvidenceGroundedAgent:
    ...
    def _render_prompt(
        ...
        return (
            ...
            "- For display.zh, all natural-language explanation, recommendation, impact, "
            "first_step, validation_tests, confidence_rationale, caveat, headings, and summaries "
            "MUST be Simplified Chinese.\n"
            "- display.zh MUST NOT contain full English sentences or English prose explanations.\n"
