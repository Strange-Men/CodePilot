...
`pytest` collected 537 tests: 536 passed, 1 skipped (`test_sandbox_rejects_paths_outside_repo`).
...
| Integration | 76 | 4 | Validate FastAPI history/errors, language review pipelines, CLI/CI workflows, MCP wrappers, diff mode, v3 agent-state persistence, useful finding fields, localized report/finding/export API responses, English leakage prevention, V3.5.5 terminology verification, and V3.5.7 lazy localization behavior. |
